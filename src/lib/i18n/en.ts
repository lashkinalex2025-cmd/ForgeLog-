...
export const en: TranslationKeys = {
  ...
  workout: {
    ...
    clearHistoryConfirm: 'Delete the entire workout history permanently?',
    deleteSelected: 'Delete selected',
    deleteSelectedConfirm: 'Delete the selected workouts?',
    selectAll: 'Select all',
    deselectAll: 'Deselect all',
    selectedCount: 'Selected: {count}',
    historyCleared: 'History cleared',
    historyDeleted: 'Workouts deleted',
    timerTab: 'Timer',
  },
  ...
  timer: {
    ...
    exercisesHint: 'Burpees\nSquats\nPlank',
    sounds: 'Sound cues',
    voice: 'Voice announcements',
    vibrate: 'Vibration',
    wakeLockHint:
      'While the timer runs, the screen stays on (Wake Lock). In the background, countdown follows wall-clock time.',
    start: 'Start',
    pause: 'Pause',
    resume: 'Resume',
    reset: 'Reset',
    ...
    finished: 'Done!',
    round: 'Round',
    hint: 'Set intervals and press Start',
    presets: 'Saved workouts',
    presetName: 'Workout name',
    untitled: 'My workout',
    noPresets: 'No saved workouts yet',
    presetSaved: 'Workout saved',
    presetLoaded: 'Workout loaded',
    openFull: 'Open full timer screen',
  },
